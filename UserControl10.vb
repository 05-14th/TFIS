Public Class Usercontrol10
    ...
    Private Sub LabelVehicle_Regulatory_Click(sender As Object, e As EventArgs) Handles LabelVehicle_Regulatory.Click

    End Sub

    Private Sub cbxMunicipality_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cbxMunicipality.SelectedIndexChanged
    ...
    Private Sub cbxCivilStatus_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cbxCivilStatus.SelectedIndexChanged
