...
Partial Class vehicleForm
    ...
    Private Sub InitializeComponent()
        ...
        cb_owner.BackColor = Color.FromArgb(CByte(255), CByte(255), CByte(255))
        cb_owner.Depth = 0
        ...
        cb_owner.Font = New Font("Microsoft Sans Serif", 14F, FontStyle.Bold, GraphicsUnit.Pixel)
        cb_owner.ForeColor = Color.FromArgb(CByte(222), CByte(0), CByte(0), CByte(0))
        ...
        or_txtbox.Font = New Font("Tahoma", 11F)
        ...
        en_txtbox.Font = New Font("Tahoma", 11F)
        ...
        tt_cb.BackColor = Color.FromArgb(CByte(255), CByte(255), CByte(255))
        tt_cb.Depth = 0
        ...
        tt_cb.Font = New Font("Microsoft Sans Serif", 14F, FontStyle.Bold, GraphicsUnit.Pixel)
        tt_cb.ForeColor = Color.FromArgb(CByte(222), CByte(0), CByte(0), CByte(0))
        ...
        ft_type.BackColor = Color.FromArgb(CByte(255), CByte(255), CByte(255))
        ft_type.Depth = 0
        ...
        ft_type.Font = New Font("Microsoft Sans Serif", 14F, FontStyle.Bold, GraphicsUnit.Pixel)
        ft_type.ForeColor = Color.FromArgb(CByte(222), CByte(0), CByte(0), CByte(0))
        ...
        nw_txtbox.Font = New Font("Tahoma", 11F)
        ...
        cn_txtbox.Font = New Font("Tahoma", 11F)
        ...
        ym_txtbox.Font = New Font("Tahoma", 11F)
        ...
        mileage_txtbox.Font = New Font("Tahoma", 11F)
        ...
        color_txtbox.Font = New Font("Tahoma", 11F)
        ...
        vid_txtbox.Font = New Font("Tahoma", 11F)
