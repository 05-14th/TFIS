...
Public Class RegisterAdmin
    ...
    Private Function RegisterAdminToDatabase() As Boolean
        ...
        Try
            ...
            Dim query As String = "INSERT INTO admindata (username, emailaddress, password) VALUES (@Username, @Email, @Password)"
    ...
    Private Sub txboxADMUS_TextChanged(sender As Object, e As EventArgs) Handles txboxADMUS.TextChanged
