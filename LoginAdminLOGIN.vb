...
Public Class LoginAdminLOGIN
    ...
    Private Sub btnLogin_Click(sender As Object, e As EventArgs) Handles btnContinue3.Click
        ...
        Dim connString As String = "Server=127.0.0.1;Database=tricyclefranchise;Uid=root;Pwd=;"
        Using conn As New MySqlConnection(connString)
            Try
                conn.Open()

                Dim query As String = "SELECT password FROM admindata WHERE username=@username"
    ...
    Private Function GetRowCount() As Integer
        ...
        Using conn As New MySqlConnection(connString)
            Try
                conn.Open()
                Dim query As String = "SELECT COUNT(*) FROM admindata" ' Adjust table name if necessary
                Using cmd As New MySqlCommand(query, conn)
    ...
    Private Sub txtboxPassUserad1_TextChanged(sender As Object, e As EventArgs) Handles txtboxPassUserad1.TextChanged
    ...
    Private Sub txtboxUserAd1_TextChanged(sender As Object, e As EventArgs) Handles txtboxUserAd1.TextChanged

    End Sub

    Private Sub labelUserAd1_Click(sender As Object, e As EventArgs) Handles labelUserAd1.Click

    End Sub

    Private Sub labelPassUserAd1_Click(sender As Object, e As EventArgs) Handles labelPassUserAd1.Click
