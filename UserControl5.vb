...
Public Class Form5Renewal
    ...
    Private Sub dtpApprovalDate_ValueChanged(sender As Object, e As EventArgs) Handles dtpApprovalDate.ValueChanged
    ...
    Private Sub cbxRenewalType_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cbxRenewalType.SelectedIndexChanged

    End Sub

    Private Sub cbxComplianceStatus_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cbxComplianceStatus.SelectedIndexChanged
