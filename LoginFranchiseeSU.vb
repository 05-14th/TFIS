...
Public Class LoginFranchiseeSU
    ...
    Private Sub labelNameSI_Click(sender As Object, e As EventArgs) Handles labelNameSI.Click

    End Sub

    Private Sub labelPassSI_Click(sender As Object, e As EventArgs) Handles labelPassSI.Click

    End Sub

    Private Sub labelFIDSI_Click(sender As Object, e As EventArgs) Handles labelFIDSI.Click

    End Sub

    Private Sub txtboxConfirmPass_TextChanged(sender As Object, e As EventArgs) Handles txtboxConfirmPass.TextChanged

    End Sub

    Private Sub txboxFNAMSI_TextChanged(sender As Object, e As EventArgs) Handles txboxFNAMSI.TextChanged
