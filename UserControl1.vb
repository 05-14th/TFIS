Public Class Form2franchise
    ...
    Private Sub cbxFranchiseType_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cbxFranchiseType.SelectedIndexChanged

    End Sub

    Private Sub tbFeePaid_TextChanged(sender As Object, e As EventArgs) Handles tbFeePaid.TextChanged
